        ...
        stage('Deploy to CloudHub dev') {
            ...
            steps {
                script {
                    ...
                    sh "${MVN} clean -DmuleDeploy -Pdev -DskipTests --settings ${MULE_SETTINGS}"
                    echo logSeparator
		}
            }
        }
...
//You will need to change the credential confguration to fit your specific installation. Two examples are shown below.
                      withCredentials([sshUserPrivateKey(credentialsId: 'neolukas@gmail.com/Macnolo.00', keyFileVariable: 'GIT_KEY_FILE', passphraseVariable: 'GIT_PASSPHRASE', usernameVariable: 'GIT_USERNAME')]) {
